...
import type { SearchProductsQuery } from "#validators/product.validations/productValidator";

export async function searchProductsService( query: SearchProductsQuery ) {
    const { q, page, limit, businessId } = query;
    ...
    // Get the products with pagination and search
